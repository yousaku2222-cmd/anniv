...
class Event {
  ...
  /// A colour-emoji icon (see `EventIcons.colored`), e.g. "🎂". Mutually
  /// exclusive with [iconCodePoint] — the edit screen clears one whenever it
  /// sets the other — and wins over it when both happen to be set.
  ...
  Event copyWith({
    ...
    return Event(
      ...
      iconEmoji: iconEmoji != null ? iconEmoji() : this.iconEmoji,
